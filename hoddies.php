...
<body>
    ...
    <?php echo(" <p style='text-transform: uppercase; text-align: center; font-size: 7rem; margin-bottom: 5px;'>HODDIES</p> ");?>
    ...
    <div class="product-grid">
        ...
        <?php
            ...
            $result = $mysqli->query("SELECT * FROM produit WHERE type = 'hoddies'");
